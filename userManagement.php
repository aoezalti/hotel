...
<div class="container">
   <form class="col-5" name="adminUpdate" method="POST" action="userManagement.php">
      ...
      <br>
       <div class="col-4">
           <div class="mb-2">
               <select class="form-select border-secondary" class="form-control" aria-label="" name="username">
      ...
      <div class="form-floating mb-2">
        <input class="form-control border-primary" id="inputfirstname" class="form-control" type="text" name="firstname" placeholder="" value="" />
        <label for="inputfirstname">Firstname</label>

      </div>

      <div class="form-floating mb-3">
        <input class="form-control border-primary" id="inputlastname" class="form-control" type="text" name="lastname" placeholder="" value="" />
