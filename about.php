...
<body>
    ...
    <h2>FAQs</h2>
    <hr color="green"/>
    <p class="dl-horizonatal"></p>
    <h3>Wie kann ich ein Zimmer buchen?</h3>
	...
	<h3>Kann ich meine Buchung online ändern?</h3>
	<p>Derzeit ist es nicht möglich, Ihre Buchung online zu ändern. Bitte kontaktieren Sie uns telefonisch, um Änderungen an Ihrer Buchung vorzunehmen.</p>

	<h3>Wie kann ich meine Buchung bezahlen?</h3>
